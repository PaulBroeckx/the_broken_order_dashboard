...
De orders werden terug gezet naar de gehardcode waardes nadat er op de knop "opnieuw laden" geklikt werd. Dit was omdat de orderCard niet de status update in de pinia store bij een onStatusChange. We hebben de store update hieraan toegevoegd en de loadOrders weggehaald van de "opnieuw laden" knop.
